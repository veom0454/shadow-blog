            ...
            <div className="socials">
              <div className="sub-col">
                <div className="menu-meta">
                  <p>Connect</p>
                  <a href="https://www.linkedin.com/in/aditya-pandey-p1002/" target="_blank" rel="noopener noreferrer"><p>LinkedIn</p></a>
                  <a href="https://github.com/Aditya060806" target="_blank" rel="noopener noreferrer"><p>GitHub</p></a>
                  <a href="https://www.instagram.com/adityapandey_06" target="_blank" rel="noopener noreferrer"><p>Instagram</p></a>
                </div>
              </div>
            </div>
          </div>
