  ...
  return (
    <>
          ...
          <div className="hero-content">
            <div className="hero-header">
              <Copy animateOnScroll={false} delay={showPreloader ? 10 : 0.85}>
                <h1>Code that feels crafted, purposeful, and quietly powerful</h1>
              </Copy>
            </div>
            <div className="hero-tagline">
              <Copy animateOnScroll={false} delay={showPreloader ? 10.15 : 1}>
                <p>
                  I build modern web experiences that are performant,
                  accessible, and designed to leave a lasting impression.
                </p>
              </Copy>
            </div>
            <AnimatedButton
        ...
        <div className="container">
          <div className="what-we-do-header">
            <Copy delay={0.1}>
              <h1>
                ...
                I craft digital experiences with purpose and precision,
                building interfaces that speak through motion, structure,
                and the quiet confidence of great engineering.
              </h1>
            </Copy>
          </div>
          <div className="what-we-do-content">
            <div className="what-we-do-col">
              ...
              <Copy delay={0.15}>
                <p className="lg">
                  I approach each project with clarity of intent. Every
                  codebase is shaped through research, iteration, and
                  attention to detail. What remains is the essential —
                  designed to perform and built to scale.
                </p>
              </Copy>
            </div>
            <div className="what-we-do-col">
      ...
      <section className="featured-projects-container">
        <div className="container">
          ...
          <div className="featured-projects-header">
            <Copy delay={0.15}>
              <h2>A selection of recent builds and creative experiments</h2>
            </Copy>
          </div>
        </div>
        <FeaturedProjects />
        ...
        <div className="container">
          ...
          <div className="gallery-callout-col">
            <div className="gallery-callout-copy">
              <Copy delay={0.1}>
                <h3>
                  Take a closer look at the projects that define my craft.
                  From interactive web apps to creative experiments, each
                  piece highlights a unique approach that might spark your
                  next idea.
                </h3>
              </Copy>
      ...
      <CTAWindow
        ...
        header="Aditya Pandey"
        callout="Code that evolves with purpose"
        description="My approach is guided by clean architecture, smooth interactions, and attention to detail — building experiences that grow more refined over time."
      />
      <ConditionalFooter />
    </>
  );
